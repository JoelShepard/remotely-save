...
export function buildS3Section(
  ...
  new Setting(body).setName(t("settings_s3_endpoint")).addText((text) =>
    text
  ...
  new Setting(body).setName(t("settings_s3_region")).addText((text) =>
    text
      .setPlaceholder("")
  ...
  new Setting(body).setName(t("settings_s3_accesskeyid")).addText((text) =>
    text
      .setPlaceholder("")
  ...
  new Setting(body).setName(t("settings_s3_secretaccesskey")).addText((text) =>
    text
      .setPlaceholder("")
  ...
  new Setting(body).setName(t("settings_s3_bucketname")).addText((text) =>
    text
      .setPlaceholder("")
